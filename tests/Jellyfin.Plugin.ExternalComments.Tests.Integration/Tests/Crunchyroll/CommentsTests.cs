...
namespace Jellyfin.Plugin.ExternalComments.Tests.Integration.Tests.Crunchyroll;
...
public class CrunchyrollCommentsTests
{
    ...
    public async Task ReturnsSuccess()
    {
        ...
        //Act
        var response = await _httpClient.GetAsync($"api/externalcomments/crunchyroll/comments/{titleId}");
