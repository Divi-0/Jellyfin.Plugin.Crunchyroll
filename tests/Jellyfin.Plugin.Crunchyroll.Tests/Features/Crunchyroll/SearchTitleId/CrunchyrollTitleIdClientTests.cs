...
public class CrunchyrollTitleIdClientTests
{
    private readonly CrunchyrollTitleIdClient _sut;
    private readonly MockHttpMessageHandler _mockHttpMessageHandler;
    private readonly ICrunchyrollSessionRepository _crunchyrollSessionRepository;
    
    public CrunchyrollTitleIdClientTests()
    {
        _mockHttpMessageHandler = new MockHttpMessageHandler();
        var logger = Substitute.For<ILogger<CrunchyrollTitleIdClient>>();
        _crunchyrollSessionRepository = Substitute.For<ICrunchyrollSessionRepository>();

        _sut = new CrunchyrollTitleIdClient(
    ...
    public async Task ReturnsSearchResponse_WhenSomethingWasFound_GivenValidName(bool isNameInLowerCase)
    {
        ...
        //Act
        var searchResponseResult = await _sut.GetTitleIdAsync(name, new CultureInfo("en-US"), CancellationToken.None);
