...
namespace Jellyfin.Plugin.Crunchyroll.Features.Crunchyroll.MetadataProvider.Series.GetMetadata.ScrapSeriesMetadata.Client;
...
public class CrunchyrollSeriesClient : ICrunchyrollSeriesClient
{
    ...
    public async Task<Result<CrunchyrollSeriesContentItem>> GetSeriesMetadataAsync(CrunchyrollId titleId, CultureInfo language, CancellationToken cancellationToken)
    {
    ...
    public async Task<Result<float>> GetRatingAsync(CrunchyrollId titleId, CancellationToken cancellationToken)
    {
        var path =
